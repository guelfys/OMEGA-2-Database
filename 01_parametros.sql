INSERT INTO parametros(codigo, descripcion, valor)VALUES('OrigenFollowme', N'', N'FollowMe');
INSERT INTO parametros(codigo, descripcion, valor)VALUES('OrigenRealstate', N'', N'Realstate');
INSERT INTO parametros(codigo, descripcion, valor)VALUES('OrigenOcr', N'', N'Ocr');
INSERT INTO parametros(codigo, descripcion, valor)VALUES('OrigenMaf', N'', N'Maf');
INSERT INTO parametros(codigo, descripcion, valor)VALUES('OrigenColiving', N'', N'Coliving');
INSERT INTO parametros(codigo, descripcion, valor)VALUES('selectsCuota', N'Listado de cuotas', N'[{"id":1,"description":"1"},{"id":2,"description":"2"},{"id":3,"description":"3"},{"id":4,"description":"4"},{"id":5,"description":"5"},{"id":6,"description":"6"},{"id":7,"description":"7"},{"id":8,"description":"8"},{"id":9,"description":"9"},{"id":10,"description":"10"},{"id":11,"description":"11"},{"id":12,"description":"12"},{"id":13,"description":"Anual"}]');
INSERT INTO parametros(codigo, descripcion, valor)VALUES(N'selectsPercep', N'Listado de percepciones', N'[{"id":1,"description":"IVA 21%"},{"id":2,"description":"IVA 27%"}]');
